...
function isCheck(turn) {
  const check = data.flat().some(e => {
    ...
    if (e.classList.contains('soldier') && e.dataset.country == turn)
      return isCheckedBySoldier(e, turn);
    if (e.classList.contains('horse') && e.dataset.country == turn)
      return isCheckedByHorse(e, turn);
    if (e.classList.contains('elephant') && e.dataset.country == turn)
      return isCheckedByElephant(e, turn);
    if (e.classList.contains('cannon') && e.dataset.country == turn)
      return isCheckedByCannon(e, turn);
    return false;
  });
  return check;
}
...
function isCheckedByCar(_this, turn) {
  ...
  if ([0, 7].includes(x) && y == 3) {
    ...
    while (true) {
      ...
      if (!rightCheck) break;
      if (rightCheck.dataset.country) {
        if (rightCheck.dataset.country != turn && rightCheck.classList.contains('king'))
          return true;
        break;
      }
      i++;
    ...
    [1, -1].forEach(r => {
      [1, -1].forEach(c => {
        ...
        if (
          ...
          rightCheck.classList.contains('king')
        )
          temp = true;
      });
    });
...
function isCheckedByHorse(_this, turn) {
  ...
  if (data[x + 1]?.[y] && !data[x + 1]?.[y].dataset.country) {
    if (
      data[x + 2]?.[y + 1] &&
      data[x + 2]?.[y + 1].dataset.country != turn &&
      data[x + 2]?.[y + 1].classList.contains('king')
    )
      return true;
    if (
      data[x + 2]?.[y - 1] &&
  ...
  if (data[x]?.[y + 1] && !data[x]?.[y + 1].dataset.country) {
    if (
      data[x + 1]?.[y + 2] &&
      data[x + 1]?.[y + 2].dataset.country != turn &&
      data[x + 1]?.[y + 2].classList.contains('king')
    )
      return true;
    if (
      data[x - 1]?.[y + 2] &&
  ...
  if (data[x]?.[y - 1] && !data[x]?.[y - 1].dataset.country) {
    if (
      data[x + 1]?.[y - 2] &&
      data[x + 1]?.[y - 2].dataset.country != turn &&
      data[x]?.[y - 1].classList.contains('king')
    )
      return true;
    if (
      data[x - 1]?.[y - 2] &&
...
function isCheckedByElephant(_this, turn) {
  ...
  if (data[x + 1]?.[y] && !data[x + 1]?.[y].dataset.country) {
    if (data[x + 2]?.[y + 1] && !data[x + 2]?.[y + 1].dataset.country) {
      if (
        data[x + 3]?.[y + 2] &&
        data[x + 3]?.[y + 2].dataset.country != turn &&
        data[x + 3]?.[y + 2].classList.contains('king')
      )
        return true;
    }
    if (data[x + 2]?.[y - 1] && !data[x + 2]?.[y - 1].dataset.country) {
  ...
  if (data[x]?.[y + 1] && !data[x]?.[y + 1].dataset.country) {
    if (data[x + 1]?.[y + 2] && !data[x + 1]?.[y + 2].dataset.country) {
      if (
        data[x + 2]?.[y + 3] &&
        data[x + 2]?.[y + 3].dataset.country != turn &&
        data[x + 2]?.[y + 3].classList.contains('king')
      )
        return true;
    }
    if (data[x - 1]?.[y + 2] && !data[x - 1]?.[y + 2].dataset.country) {
